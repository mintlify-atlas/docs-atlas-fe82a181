---
title: "Users API — Manage System Users and Roles"
...
<Warning>
  El borrado lógico **no impide** que el usuario intente autenticarse si conoce sus credenciales. Para bloquear el acceso completamente, también actualiza `activo: false` con un PUT antes de hacer el DELETE, o cambia su contraseña.
</Warning>
