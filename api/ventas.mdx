---
title: "Sales API — Register, Query, and Void Transactions"
sidebarTitle: "Ventas"
...
<ResponseField name="numeroVenta" type="string">
  Auto-generated sale number in the format `VNT-00001`.
</ResponseField>
...
<ResponseField name="estado" type="string">
  Current sale status: `COMPLETADA` or `ANULADA`.
</ResponseField>
