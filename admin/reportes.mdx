---
title: "Generación de Reportes PDF de Ventas e Inventario"
sidebarTitle: "Reportes"
description: "Genera y descarga reportes PDF de ventas e inventario directamente desde la API. Función exclusiva del rol ADMIN en Tiendas Mi Cholo."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Reporte de Inventario" icon="boxes-stacked">
    ...
    **Orientación:** A4 vertical con celdas resaltadas para stock bajo.
