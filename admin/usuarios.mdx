---
title: "Gestión de Usuarios del Sistema y Control de Acceso"
sidebarTitle: "Usuarios"
description: "Administra los usuarios del sistema, asigna roles (ADMIN, VENDEDOR, ALMACENERO) y controla el acceso a cada módulo. Exclusivo para ADMIN."
---
