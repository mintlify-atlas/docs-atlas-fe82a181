---
title: "Registrar y Gestionar Ventas en Tiendas Mi Cholo"
sidebarTitle: "Ventas"
...
<Steps>
  ...
  <Step title="Stock descontado e inventario actualizado">
    Por cada línea de detalle, `stockActual` del producto se reduce en la cantidad vendida y se registra un `Inventario` con `tipo = SALIDA`, `motivo = "Venta VNT-YYYY-NNNN"` y referencia a la venta.
  </Step>
</Steps>
...
3. Se crea un movimiento de inventario con `tipo = ENTRADA` y `motivo = "Anulación venta VNT-YYYY-NNNN"`.
