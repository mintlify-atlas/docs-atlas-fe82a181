---
title: "Gestión de Productos y Catálogo de Inventario"
sidebarTitle: "Productos"
description: "Administra el catálogo de productos con precios de compra/venta, stock mínimo, categorías y alertas automáticas de stock bajo."
---
...
<Tabs>
  <Tab title="Listar / Buscar">
    ...
    ```
    Búsqueda full-text por `nombre`, `codigo` o `descripcion`.
