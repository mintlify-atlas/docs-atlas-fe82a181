---
title: "Authenticate with Tiendas Mi Cholo JWT API"
sidebarTitle: "Autenticación"
description: "Obtén tokens JWT con POST /api/auth/login y pásalos como Bearer token en el header Authorization en cada petición protegida."
---
