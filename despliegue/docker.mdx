---
title: "Deploy Tiendas Mi Cholo with Docker Compose"
sidebarTitle: "Docker Compose"
description: "Levanta MySQL 8 y phpMyAdmin con un solo comando usando el docker-compose.yml incluido. El schema y datos iniciales se cargan automáticamente."
---
